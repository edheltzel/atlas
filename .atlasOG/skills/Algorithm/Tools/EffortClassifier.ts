...
const PATTERNS = {
  TRIVIAL: {
    keywords: [
      "hello", "hi", "hey", "thanks", "thank you", "got it",
      "ok", "okay", "cool", "awesome", "great", "nice",
      "yes", "no", "sure",
    ],
    patterns: [
      /^(hi|hello|hey)[\s!.,]*$/i,
  ...
  QUICK: {
    keywords: [
      "quick", "simple", "just", "only", "typo",
      "rename", "change", "update",
    ],
    patterns: [
      /fix (the |a )?typo/i,
      /rename \w+ to \w+/i,
  ...
  THOROUGH: {
    keywords: [
      "thorough", "comprehensive", "complete", "full",
      "architecture", "refactor", "redesign", "overhaul",
      "system", "complex",
    ],
    patterns: [
      /refactor/i,
...
const COMPLEXITY_INDICATORS = {
  high: [
    ...
    "migration", "api", "integration", "deploy", "infrastructure",
    "performance", "optimization", "architecture", "refactor", "redesign",
  ],
  medium: [
    "feature", "component", "page", "form", "validation",
    "test", "style", "layout", "responsive", "modal", "dialog",
  ],
  low: [
    "typo", "comment", "rename", "color", "text",
