#!/bin/bash
# ═══════════════════════════════════════════════════════════════════════════════
# Rosé Pine Theme - Moon (Darker)
# ═══════════════════════════════════════════════════════════════════════════════
# All natural pine, faux fur and a bit of soho vibes for the classy minimalist
# Moon variant - darker, more contrast
# https://rosepinetheme.com
# ═══════════════════════════════════════════════════════════════════════════════

THEME_NAME="Rosé Pine Moon"
THEME_VARIANT="dark"
...
# Love:    #eb6f92
# Gold:    #f6c177
# Rose:    #ea9a97 (slightly different from main)
# Pine:    #3e8fb0 (brighter than main)
# Foam:    #9ccfd8
# Iris:    #c4a7e7
...
# Surface tones
OVERLAY='\033[38;2;57;53;82m'           # #393552

# Accent colors
LOVE='\033[38;2;235;111;146m'           # #eb6f92 - Red/Pink
GOLD='\033[38;2;246;193;119m'           # #f6c177 - Yellow/Orange
ROSE='\033[38;2;234;154;151m'           # #ea9a97 - Pink/Salmon (Moon variant)
PINE='\033[38;2;62;143;176m'            # #3e8fb0 - Teal (brighter)
